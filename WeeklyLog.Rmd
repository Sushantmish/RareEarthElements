...
dir.create(path = "~/Desktop/MSci Project/RareEarthElements/Simplified_Data")
for (rock_name in names(simplified_rocks))
     {
       saveas <- simplified_rocks[[rock_name]]
       directory <- paste0("~/Desktop/MSci Project/RareEarthElements/Simplified_Data",rock_name,".csv")
       write.csv(saveas,file = directory,row.names = FALSE)
     }
```
