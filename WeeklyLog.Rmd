...
# make total_ree +ve 
projected_scores_chur$Total_REE <- projected_scores_chur$Total_REE * -1
...
for(i in 1:length(axes_pair)) 
{
  ...
  plot(x_val, y_val, xlab = paste(x_n, "(vs CHUR)"), ylab = paste(y_n, "(vs CHUR)"),main = paste(x_n, "vs", y_n, "Normalized to CHUR"),pch = 19, cex = 0.6, xlim = x_limit, ylim = y_limit,col = ifelse(plot_data_chur$Short_Name == "CHUR", "blue", "black"))
